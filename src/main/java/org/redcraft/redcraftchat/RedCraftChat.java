...
@Plugin(id = "redcraftchat", name = RedCraftChat.PLUGIN_NAME, version = "0.2.7-SNAPSHOT", url = "https://redcraft.org", description = "Multi language chat and Discord bridge", authors = {
		"RedCraft" })
