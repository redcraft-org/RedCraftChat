...
public class MessageTokenizerTest extends TestCase {
    ...
    public void testTokenizer() {
        ...
        String expectedRawTokenizedMessage = "Hello 280aa0a, can you check dc20cb6 on 1d36664 please? You can also use 3eccd38 if you want to 05319c3";
    ...
    public void testUntokenizer() {
        String testRawMessage = "Hello 280aa0a, can you check dc20cb6 on 1d36664 please? You can also use 3eccd38 if you want to 🤷‍♀️";
